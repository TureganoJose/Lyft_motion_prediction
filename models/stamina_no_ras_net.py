...
class STAMINA_no_ras_net(nn.Module):
    def __init__(self, cfg: Dict, n_agents=100, n_car_states=7, n_frames=11, batch_size=32, device='cpu',
        ...
        super(STAMINA_no_ras_net, self).__init__()
        # General parameters
        self.n_agents = n_agents
        self.n_car_states = n_car_states
        ...
        self.total_concat_size = 2 * spatial_en_hid_size + 2 * temp_en_hid_size
        # ==== DEFINING MODEL
        # Temporal Encoders
